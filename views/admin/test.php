                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <span class="fw-medium d-block">วรนุช วงศ์สวรรค์</span>
                                                    <small class="text-muted">Admin Sales</small>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                            <div class="mb-2 mb-md-0">
                                ระบบทะเบียนสัญญา
                                ,
                                <a href="" class="footer-link fw-medium">กรณีศึกษา บริษัท ฮิตาชิ เอลลิเวเตอร์ (ประเทศไทย)</a>
                            </div>
