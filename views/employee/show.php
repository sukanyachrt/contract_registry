                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="d-flex mb-0">
                            ...
                            <div class="flex-grow-1 row">
                                <div class="col-6 col-sm-7 mb-sm-0">
                                    <h4 class="py-3 mb-2">รายละเอียดข้อมูลพนักงาน<span class="text-muted fw-light"> </span> </h4>
                                </div>
                                <?php
                                ...
                                ?>
                                    <div class="col-6 col-sm-5 text-end pt-3">
                                        ...
                                        <button type="button" class="btn btn-xs btn-danger" onclick="updateEmployStatus('<?php echo $_GET['id'] ?>')">
                        ...
                        <div class="row">
                            <div class="col-lg-12 mb-4 order-0">
                                <div class="card">
                                    <div class="card-body" id="load_detail_employ">
...
<script>
    ...
    function load_detail_employ() {
        var xhttp = new XMLHttpRequest();
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                document.getElementById("load_detail_employ").innerHTML = this.responseText;

            }
        };
        xhttp.open("GET", "../../services/employee/show.php?id=<?php echo $_GET['id'] ?>", true);
        xhttp.send();
    }
