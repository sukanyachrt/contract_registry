                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive text-nowrap">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody id="tablelistContract"></tbody>
                                            </table>
                                        </div>
                                    </div>
                                </div>
    ...
    function tablelistContract() {
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                document.getElementById("tablelistContract").innerHTML = this.responseText;
            }
        };
        xhttp.open("GET", "../../services/contract/tablelistContract.php", true);
        xhttp.send();
    }
    $("#search").on("keyup", function() {
        var value = $(this).val().toLowerCase();
        $("#tablelistContract tr").filter(function() {
